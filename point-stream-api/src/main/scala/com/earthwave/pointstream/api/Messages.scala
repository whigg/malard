...
case class SwathToGridCellsRequest( envName : String, parentDataSet : String, dataSet : String, region : String, inputFileName : String, inputFilePath : String, dataTime : Long, columnFilters : Map[String, Double], includeColumns : Set[String], gridCellSize : Long, hash : Long )
