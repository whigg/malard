...
case class SwathToGridCellsRequest( envName : String, parentDataSet : String, dataSet : String, region : String, inputFileName : String, inputFilePath : String, dataTime : Long, columnFilters : List[Filter], includeColumns : Set[String], gridCellSize : Long, xCol : String, yCol : String, y hash : Long )
