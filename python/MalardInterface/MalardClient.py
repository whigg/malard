...
class MalardClient:
    def __init__(self, environmentName='DEVv2', notebook = True):
        ...
        self.query = mi.DataSetQuery( "http" + self.serverUrl, self.environmentName )
        self.asyncQuery = mi.AsyncDataSetQuery( "ws" + self.serverUrl, self.environmentName, notebook )    
    ...
    def boundingBox(self, dataSet ):
        ...
        return mi.BoundingBox( dataSet, minX, maxX, minY, maxY, minT, maxT, numberOfPoints )
    ...
    def gridCells( self, boundingBox):
        ...
        return [mi.BoundingBox( bb.dataSet, gc['gridCellMinX'], gc['gridCellMaxX'], gc['gridCellMinY'], gc['gridCellMaxY'], gc['minTime'], gc['maxTime'], gc['totalPoints'] ) for gc in gcs ]
